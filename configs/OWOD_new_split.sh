...
python -u main_open_world.py \
    ...
    --backbone 'dino_resnet50' \
    --pretrain 'exps/OWDETR_t3/checkpoint0139.pth' \
    ${PY_ARGS}
...
#    --unmatched_boxes --epochs 220 --top_unk 5 --featdim 1024 --NC_branch --nc_loss_coef 0.1 --nc_epoch 9 \
#    --backbone 'dino_resnet50' \
#    --pretrain 'exps/OWDETR_t4/checkpoint0199.pth' \
#    ${PY_ARGS}